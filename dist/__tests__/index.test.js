...
describe("Testing server", () => {
    ...
    it("should check that the POST /accommodation endpoint creates and returns a new post ", async () => {
    ...
    it("should check that the POST /accommodation endpoint returns 400 if data is incorrect", async () => {
    ...
    it("should check that the  GET /accommodation/:id endpoint returns a single accommodation by id", async () => {
    ...
    it("should test that the PUT /accommodation/:id endpoint returns 404 if the accommodation does not exist ", async () => {
